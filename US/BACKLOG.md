...
| US-032 | Fréquence « certains jours du mois » pour une habitude | Should | livrée | M | US/done/US-032-frequence-jours-du-mois.md |
| US-033 | Cohérence du suivi et des rappels avec la fréquence « jours du mois » | Should | livrée | S | US/done/US-033-coherence-suivi-rappels-frequence-mensuelle.md |
| US-034 | Résumé de la semaine entièrement visible sans défilement horizontal | Should | livrée | M | US/done/US-034-resume-semaine-sans-scroll-horizontal.md |
| US-035 | Trois états visuels distincts dans le résumé (fait / à faire / manqué) | Should | livrée | M | US/done/US-035-resume-trois-etats-fait-a-faire-manque.md |
| US-036 | Palette de couleurs de carte et couleur choisie par habitude | Should | livrée | M | US/done/US-036-palette-couleur-carte-habitude.md |
...
32. **US-032** — Fréquence « certains jours du mois » pour une habitude (Should) — *lot « récurrence mensuelle » (2026-08-14)* : troisième mode de fréquence, sélection multiple de jours 1–31, repli sur le dernier jour du mois quand le jour n'existe pas, déduplication des replis sur la même date, rétro-compatibilité stricte des habitudes déjà persistées (aucune migration)
33. **US-033** — Cohérence du suivi et des rappels avec la fréquence « jours du mois » (Should) — à livrer **immédiatement après US-032** : sans elle, la fréquence mensuelle serait visible dans le planning mais mal comptabilisée dans le résumé, la régularité, les rappels et le badge (chiffres faux, plus dommageable qu'une absence de fonctionnalité). Même nature que US-019 vis-à-vis d'US-017/US-018
34. **US-034** — Résumé de la semaine entièrement visible sans défilement horizontal (Should) — *lot « refonte du résumé » (2026-08-14)*, volet mise en page : périmètre volontairement limité à la période « semaine », le mois conservant son défilement horizontal (arbitrage utilisateur explicite)
35. **US-035** — Trois états visuels distincts dans le résumé : fait ✅ / à faire ⬜ / manqué ❌ (Should) — volet langage visuel, **à livrer après US-034** (ou coordonné avec elle) pour ne pas réintroduire de débordement horizontal. **Révise explicitement, et uniquement pour le résumé, l'arbitrage produit du 2026-08-12 « lecture neutre et apaisée de la régularité »** — décision prise par l'utilisateur en connaissance de cause ; les cartes d'habitude (US-024/US-025) et l'interdiction de toute mécanique de streak restent inchangées

36. **US-036** — Palette de couleurs de carte et couleur choisie par habitude (Should) — *lot « personnalisation des cartes » (2026-08-14)*, premier volet : crée la **palette pastel fermée partagée** (6 à 8 teintes, déclinaison claire ET sombre par teinte, contraste garanti) dans la source de vérité unique d'US-009/US-029, et l'applique aux habitudes. Champ optionnel, `undefined` = teinte par défaut identique au rendu actuel — aucune migration
37. **US-037** — Couleur choisie par tâche ponctuelle (Should) — second volet, **à livrer après US-036** dont elle réutilise strictement la palette, les déclinaisons et les règles de contraste ; ne crée aucune teinte propre
38. **US-038** — Ordre d'affichage des tâches d'un même jour par heure limite (Should) — *lot « priorisation des tâches » (2026-08-14)*, premier volet : **introduit** un ordre de tri là où il n'en existait aucun (les tâches s'affichent aujourd'hui dans leur ordre d'insertion, `tasksOn` étant un simple filtre ; `/taches` ne trie que par date). Livrable seule, valeur immédiate
39. **US-039** — Marquer une tâche comme urgente et la faire remonter en tête du jour (Should) — second volet, **à livrer après US-038** dont elle étend la règle d'ordre d'un critère de groupe prioritaire (urgentes d'abord, sans heure limite en tête du groupe urgent). Urgence purement manuelle, sans escalade, sans notification supplémentaire et sans teinte imposée (arbitrages PO tracés dans l'US)
40. **US-040** — Accès complet à l'application hors connexion une fois installée (Must) — *ajoutée le 2026-08-16, en réponse à BUG-002 : régression bloquante sur la promesse « offline-first » d'ADR-001, jusqu'ici sans critère de recette formalisé.* **Priorité absolue : à traiter immédiatement, avant toute autre US non livrée du backlog** (avant US-008 et US-030), correctif ciblé sur le service worker déjà livré par US-007. Arbitrages produit tranchés le 2026-08-16 (écran de repli avec retour au planning, mise à jour silencieuse différée au prochain lancement, actions réseau rejouées au retour de la connexion, clôture conditionnée à des tests automatisés **et** à une validation sur iPhone réel) — le troisième arbitrage élargit le périmètre initial, d'où l'estimation portée de M à L
...
- US-032 dépend de US-001 (formulaire de création/édition et modèle de fréquence à étendre d'un troisième mode) et US-004 (planning devant afficher les occurrences mensuelles au bon jour) ; contrainte non négociable : **aucune migration destructive** de la persistance locale existante
- US-033 dépend de US-032 (fréquence mensuelle à propager), US-005/US-006 (résumé et seuils), US-007/US-023 (rappels et resynchronisation), US-024/US-025 (régularité et signal « manquée hier ») et US-031 (badge) — aucune règle produit existante n'est modifiée, seule leur bonne prise en compte du nouveau mode est garantie
- US-034 dépend de US-005 (tableau du résumé existant) ; n'affecte volontairement ni la période « mois » ni la période « année »
- US-036 dépend de US-001 (formulaire d'habitude à étendre), US-009 (centralisation des variables de couleur, où la palette doit vivre), US-029 (déclinaison sombre obligatoire de chaque teinte, parité de variables déjà testée par `src/app.css.test.ts`), US-010 (habillage de carte partagé) et US-026 (le formulaire complet étant réutilisé par l'ajout rapide, le champ y apparaît sans travail spécifique) ; contrainte non négociable : **champ optionnel, aucune migration destructive**
- US-037 dépend de US-036 (palette, déclinaisons claire/sombre, couleur par défaut et règles de contraste réutilisées telles quelles), US-002 (formulaire de tâche à étendre) et US-003 (la couleur doit survivre à une reprogrammation) ; même contrainte de rétro-compatibilité
- US-038 dépend de US-004 (liste des tâches du jour, aujourd'hui sans tri explicite), US-021 (heure limite, critère de tri) et US-003 (insertion correcte d'une tâche reprogrammée) ; aucun impact sur les rappels push, aucun changement de modèle
- US-039 dépend de US-038 (règle d'ordre à étendre d'un critère de groupe prioritaire — d'où l'ordre de livraison), US-002 (formulaire à étendre), US-026 (ajout rapide) et, en lecture seule et sans modification, US-021/US-022 (heure limite et push nominatif inchangés) ; indépendante d'US-037 dans les deux sens (l'urgence n'impose aucune teinte)
- US-035 dépend de US-005 (statut de cellule existant à étendre), US-019 (dérivation binaire des habitudes à cible chiffrée, réutilisée telle quelle), US-029 (palette sombre dans laquelle les trois états doivent rester distinguables), US-034 (contrainte de largeur en vue semaine à ne pas casser) et US-013/US-015 (statuts supprimée/en pause, qui neutralisent l'état « manqué ») ; US-033 et US-035 sont indépendantes l'une de l'autre et livrables dans n'importe quel ordre
- US-040 dépend de US-007 (service worker déjà livré, composant technique corrigé par cette US) et matérialise en critères de recette testables la décision « offline-first » d'ADR-001 (qu'elle ne révise pas) ; correctif du défaut technique documenté dans BUG-002 (`bug/to_be_resolved/BUG-002-pwa-inutilisable-hors-ligne-iphone.md`), qui devient son critère de recette formel. **Priorité absolue, hors ordre chronologique de cette liste** : régression bloquante sur la proposition de valeur cœur du produit, à traiter avant toute autre US non livrée (US-008, US-030)
